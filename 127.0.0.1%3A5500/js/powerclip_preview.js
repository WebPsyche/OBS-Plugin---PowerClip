       ...
       // const hideVideo = new BroadcastChannel('hide_video')
        ...
        $vidShows[i].addEventListener('click',()=>{
           ...
           if($vidShows[i].classList.contains('showBoxShadow')){
                ...
                slideVideo.postMessage(new slides)
           }else{
        ...
        $backgroundColor[i].addEventListener('input',(event)=>{
            $allSlides[i].background.backgroundColor = event.target.value
            $backgroundColor[i].style.backgroundColor = event.target.value
        })
        ...
        $headerTextPositionLeftX[i].addEventListener('click',()=>{
            headerTextPositionX--
            $allSlides[i].header.headerPositionX = headerTextPositionX + "%";
            console.log( $allSlides[i].header.headerPositionX)
        })
        ...
        let headerTextPositionY = 0;
         $headerTextPositionUpY = document.querySelectorAll('.headerTextPositionUpY')
         $headerTextPositionUpY[i].addEventListener('click',()=>{
            headerTextPositionY--
             $allSlides[i].header.headerPositionY = headerTextPositionY + "%";
             console.log( $allSlides[i].header.headerPositionY)
         })
         //header text position down
         $headerTextPositionDownY = document.querySelectorAll('.headerTextPositionDownY')
         $headerTextPositionDownY[i].addEventListener('click',()=>{
            headerTextPositionY++
             $allSlides[i].header.headerPositionY = headerTextPositionY + "%";
             console.log( $allSlides[i].header.headerPositionY)
         })
         ...
         $headerTextFontSizeIncrease[i].addEventListener('click',()=>{
           ...
           $alignBodyTextRight[i].addEventListener('click',()=>{
            ...
            $bodyTextPositionLeftX[i].addEventListener('click',()=>{
                ...
                console.log($allSlides[i].body.bodyPositionX)
            })
            //body position right
            ...
            $bodyTextPositionUpY[i].addEventListener('click',()=>{
                ...
                console.log( $allSlides[i].body.bodyPositionY)
            })
